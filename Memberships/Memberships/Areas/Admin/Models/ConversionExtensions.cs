...
namespace Memberships.Areas.Admin.Models
{
    public static class ConversionExtensions
    {
        ...
        public static async Task<List<SubscriptionProductModel>> Convert( this IQueryable<SubscriptionProduct> subscriptionProduct,ApplicationDbContext db)
        {
            var model = await (
        ...
        {
            var oldPI = await db.SubscriptionProducts.CountAsync(pi => pi.ProductId.Equals(subscriptionProduct.OldProductId) &&
            pi.SubscriptionId.Equals( subscriptionProduct.OldSubscriptionId));
            var newPI = await db.SubscriptionProducts.CountAsync(pi => pi.ProductId.Equals(subscriptionProduct.ProductId) &&
